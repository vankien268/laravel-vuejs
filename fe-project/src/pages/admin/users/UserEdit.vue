        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-8">
            ...
            <div class="row mt-3">
              ...
              <div class="col-12 col-sm-5">
                <a-checkbox v-model:checked="change_password">Checkbox</a-checkbox>
              </div>
            </div>
  
            <div class="row mt-3" v-if="change_password === true">
              <div class="col-12 col-sm-3 text-start text-sm-end">
                <label>
                  <span class="text-danger me-1"> * </span>
                  <span>Mật khẩu: </span>
  ...
  export default defineComponent({
    ...
    getUserCreate();
      ...
      const getUserEdit = () => {
        ...
        axios
          .get(`http://127.0.0.1:8000/api/v1/users/${route.params.id}/edit`)
          .then((res) => {
            const {
                name, email, username, department_id, status_id
            } = res.data.data;
            user.name = name;
            user.email = email;
      ...
      const updateUser = () => {
        axios
          .put(`http://127.0.0.1:8000/api/v1/users/update/${route.params.id}`, user)
          .then((res) => {
